...
export default function Profile(props) {
    ...
    function renderDisplay() {
        return(
            ...
            <div className="ProfileTextTagsContainer">
                <div className="picTextContainer">
                    ...
                    <div className="profileTextContainer">
                        ...
                        <a className="CoOpContact" href={websiteLink} target="_blank">{website}</a>
                        <a className="CoOpContact" href={emailLink} target="_blank">{email}</a>
            ...
            <div className="socialsDiv">
                <a href={instaLink} target="_blank"><img src={facebook} className="socialButton"/></a>
                <a href={fbLink} target="_blank"><img src={instagram} className="socialButton"/></a>
            </div>
        </div>
    );  
